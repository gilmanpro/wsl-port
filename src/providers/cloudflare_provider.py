"""CloudflareProvider: cloudflared tunnel.
...
is_alive via Popen (a diferencia de tailscale, cloudflared corre en foreground).

Adaptado desde port-forwarder-app/src/providers/cloudflare_provider.py
...
from src.core.forward_config import Tunnel
