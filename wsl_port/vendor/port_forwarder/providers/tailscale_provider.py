"""TailscaleProvider: tailscale serve / funnel (T7, P2; Anexo A).

Comandos (mejor esfuerzo, dependen de la version de tailscale):
...
No testeado contra una instalacion real (requiere tailscale up).
"""
