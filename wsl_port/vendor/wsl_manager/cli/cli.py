...
from wsl_port.vendor.wsl_manager import __version__
from wsl_port.vendor.wsl_manager.cli import commands_distros, commands_limits, commands_monitor, commands_schedule, commands_ux
from wsl_port.vendor.wsl_manager.cli.common import new_context
...
def main_callback(
    ...
    if log_level:
        from wsl_port.vendor.wsl_manager.core.logger import setup_logging
